    ...
    <div un-flex='~' un-gap='2' >
      <div un-w='full' un-flex='~' un-items='center' >
        <NavLink to="/z-editor/search" prefetch='render'>
          {({ isActive }) => <div un-flex='~' un-text={`${isActive && 'blue-400'} hover:blue-400`} un-gap='0.5' un-mx='2'>
            <span className="i-material-symbols-light:search" un-text='2xl' />
            Search
          </div>}
        </NavLink>
        <NavLink to="/z-editor/alert" prefetch='render'>
          {({ isActive }) => <div un-flex='~' un-text={`${isActive && 'blue-400'} hover:blue-400`} un-gap='0.5' un-px='2'>
