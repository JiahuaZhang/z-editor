...
export const $convertCollapsibleContentElement = (domNode: HTMLElement): DOMConversionOutput | null => {
...
export const $isCollapsibleContentNode = (node: LexicalNode | null | undefined): node is CollapsibleContentNode => node instanceof CollapsibleContentNode;