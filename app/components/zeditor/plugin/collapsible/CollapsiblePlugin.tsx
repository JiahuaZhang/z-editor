...
import { $createParagraphNode, $getSelection, $isRangeSelection, COMMAND_PRIORITY_LOW, createCommand, DELETE_CHARACTER_COMMAND, ElementNode, INSERT_PARAGRAPH_COMMAND, KEY_ARROW_DOWN_COMMAND, KEY_ARROW_LEFT_COMMAND, KEY_ARROW_RIGHT_COMMAND, KEY_ARROW_UP_COMMAND, LexicalNode } from 'lexical';
    ...
    return mergeRegister(
      ...
      editor.registerCommand(
        ...
        () => {
          ...
          if (!$isCollapsibleContainerNode(container) || container.getOpen()) return false;
