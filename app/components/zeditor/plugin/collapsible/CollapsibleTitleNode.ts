...
import { $createParagraphNode, $isElementNode, DOMConversionMap, DOMConversionOutput, EditorConfig, ElementNode, LexicalEditor, LexicalNode, RangeSelection, SerializedElementNode } from 'lexical';
...
export const $convertSummaryElement = (domNode: HTMLElement): DOMConversionOutput | null => {
...
export class CollapsibleTitleNode extends ElementNode {
  ...
  createDOM(config: EditorConfig, editor: LexicalEditor): HTMLElement {
    ...
    dom.className = config.theme.summary;
...
export const $isCollapsibleTitleNode = (node: LexicalNode | null | undefined): node is CollapsibleTitleNode => node instanceof CollapsibleTitleNode;