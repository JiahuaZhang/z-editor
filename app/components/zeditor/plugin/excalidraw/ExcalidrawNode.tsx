...
const ExcalidrawComponent = lazy(() => import('./ExcalidrawComponent').then(module => ({ default: module.ExcalidrawComponent })));
...
const $convertExcalidrawElement = (domNode: HTMLElement): DOMConversionOutput | null => {
...
export const $createExcalidrawNode = (data: string = '[]', width: Dimension = 'inherit', height: Dimension = 'inherit') => new ExcalidrawNode(data, width, height);

export const $isExcalidrawNode = (node: LexicalNode | null | undefined): node is ExcalidrawNode => node instanceof ExcalidrawNode;