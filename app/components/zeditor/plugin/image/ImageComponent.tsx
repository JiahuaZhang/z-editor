  ...
  return <Suspense>
    <div un-mx='1' >
      ...
      >
        ...
        <RichTextPlugin
          contentEditable={<ContentEditable un-position='relative' un-border='rounded-b top-0 solid x-2 b-2 blue-100 focus-within:blue-6' un-p='1' un-outline='none' un-text='sm' un-bg='white' role='lexical-image-caption' />}
          placeholder={
