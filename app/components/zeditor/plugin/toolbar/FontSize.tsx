  ...
  return <Suspense>
    <div un-flex='~' un-items='center' un-gap='1' >
      <Tooltip title={`Decrease font size (${SHORTCUTS.DECREASE_FONT_SIZE})`}>
        <button un-text='disabled:gray-300 gray-500' un-translate-y='-0.25' aria-label="Decrease font size"
      ...
      <Tooltip title='Font Size' >
        <input un-border='2 solid zinc-300 rounded' un-w='8' un-text='sm center' un-cursor='disabled:not-allowed'
      ...
      <Tooltip title={`Decrease font size (${SHORTCUTS.INCREASE_FONT_SIZE})`}>
        <button un-text='disabled:gray-300 gray-500' un-translate-y='-0.25' aria-label="Increase font size"
